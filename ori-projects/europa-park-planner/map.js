...
let profile=null,selections={},mapQuery='',chosenOnly=false,parkMap=null;
...
function focusRequested(){const id=new URLSearchParams(location.search).get('ride'),marker=markers.get(id);if(!marker)return;parkMap.setView(marker.getLatLng(),19,{animate:true});marker.openPopup()}
